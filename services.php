		...
		<div class="top-header-main">
			...
			<div class="col-md-8 header-address wow bounceInRight" data-wow-delay="0.3s">
				<ul>
					...
					<li><span class="email"> </span><h6><a href="mailto:info@example.com">Srilekhapaul@gmail.com</a></h6></li>
				</ul>
			</div>
...
?>
			    ...
			    <div class="rooms-left wow slideInLeft" data-wow-delay="0.3s">
				 	<div class="col-md-4 rooms-text">
				 	    ...
				 	    <div class="room-btn">
				 	     <h3>Price:<?php echo $row['rent']; ?></h3>	
				 	    </div>		 	    
				 	</div>
				 	<div class="col-md-8 rooms-img">
				 		<div class="luxury-block">
				 		 <a href="#"> <img style="width:300px" src="admin/upload/<?php echo $row['picture']; ?>" alt="" class="img-responsive"></a>		
						</div>
				 	</div>				 
				  <div class="clearfix"> </div>
			    </div>
